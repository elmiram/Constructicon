...
ROOT_URLCONF = 'constructicon.urls'

WSGI_APPLICATION = 'constructicon.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'constructicon',                      # Or path to database file if using sqlite3.
...
STATIC_URL = '/constructicon/static/'
...
LOCALE_PATHS = (
    '/home/elmira/constructicon/locale',
)